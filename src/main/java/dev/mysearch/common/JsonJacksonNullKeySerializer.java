...
class JsonJacksonNullKeySerializer extends StdSerializer<Object> {

	public JsonJacksonNullKeySerializer() {
		this(null);
	}

	public JsonJacksonNullKeySerializer(Class<Object> t) {
		super(t);
	}
	...
	public void serialize(Object nullKey, JsonGenerator jsonGenerator, SerializerProvider unused) throws IOException, JsonProcessingException {
		jsonGenerator.writeFieldName(StringUtils.EMPTY);
	}
}